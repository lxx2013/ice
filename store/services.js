...
const baseUrl = 'http://rapapi.org/mockjsdata/34116/wiki/citys'
const testUrl = 'https://setsuna-wechat.localtunnel.me'
...
class Services {
  ...
  getWechatSignature (url) {
    return axios.get(`${testUrl}/wechat-signature?url=${encodeURIComponent(url)}`)
  }
   ...
   */
  getWechatOAuth (url) {
    return axios.get(`${testUrl}/wechat-oauth?url=${encodeURIComponent(url)}`)
  }
